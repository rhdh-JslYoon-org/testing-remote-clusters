...
!!! info
    ...
    **Source Code Repository:** [https://github.com/rhdh-JslYoon-org/testing-remote-clusters](https://github.com/rhdh-JslYoon-org/testing-remote-clusters)

    **GitOps Repository:** [https://github.com/rhdh-JslYoon-org/testing-remote-clusters-gitops](https://github.com/rhdh-JslYoon-org/testing-remote-clusters-gitops)

# **Usage**

To access the testing-remote-clusters application that was deployed using the Software Template, complete the following instructions:
...
If you are interested in seeing the deployed Kubernetes resources, all resources were deployed into your chosen namespace of testing-remote-clusters. You can access this namespace through the web console or via your CLI.
