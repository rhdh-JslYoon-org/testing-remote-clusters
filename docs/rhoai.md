...
2) Go to the `Data Science Projects` section and access your application's project named `testing-remote-clusters`.

![image](./images/data-science-projects.png)

3) Access the `workbench` named `testing-remote-clusters-notebook`.
...
5) In the terminal, run `cd testing-remote-clusters` to navigate to your sample app's directory.
